...
* `1/05`
  ...
  * 미디어쿼리 적용하는데 css가 마음에 안듦 + 디자인이 가시화되지 않은 채로 하려니까 진도가 안나감
  * 해결 방안 => figma로 모바일 버전 디자인
* `1/09`

  * figma 모바일 디자인 (모바일 버젼디자인)[https://www.figma.com/file/Sb6EbxPf2SpXOYYy9xmuH9/Dorecipe_new?node-id=217%3A7380]
  * react-query 마이그레이션 준비
