...
console.log(
  ...
  categoryChangeLinks.findIndex(
    (element) =>
      element.cat3 == cat3[cat3.length - 1] && //17
      element.cat4 == ""
    // element.cat3 == cat3[cat3.length - 1]
    // &&//305
    // element.cat2 == cat2[cat2.length - 1] && //4589
    // element.cat1 == cat1[cat1.length - 1] //68849
  )
);
console.log(
  "categoryChangeLinks.findIndex cat3~~~~~~~~~~~~~~~~~~~~~~~~~",
  categoryChangeLinks.findIndex(
    (element) =>
      // element.cat3 == cat3[cat3.length - 1] && //17
      // element.cat2 == cat2[cat2.length - 1] &&
      element.cat2 == 12 &&
      element.cat1 == "" &&
      element.cat4 == "" &&
      element.cat3 == ""
    ...
    // &&//305
    // element.cat2 == cat2[cat2.length - 1] && //4589
    // element.cat2 == cat1[cat1.length - 1] //68849
  )
);
console.log(
  "categoryChangeLinks[18 + 17 + 1]",
  categoryChangeLinks[18 + 17 + 1]
); //{ cat1: '', cat2: '', cat3: 70, cat4: '' }

console.log("categoryChangeLinks[64260]", categoryChangeLinks[64260]); //{ cat1: 11, cat2: '', cat3: '', cat4: '' }
console.log("categoryChangeLinks[4284]", categoryChangeLinks[4284]); //{ cat1: '', cat2: 22, cat3: '', cat4: '' }
console.log("categoryChangeLinks[306]", categoryChangeLinks[306]); //{ cat1: '', cat2: 22, cat3: '', cat4: '' }

console.log("categoryChangeLinks[288]", categoryChangeLinks[288]); // { cat1: '', cat2: '', cat3: 34, cat4: '' }
console.log("categoryChangeLinks[17]", categoryChangeLinks[17]); // { cat1: '', cat2: '', cat3: '', cat4: 62 }

console.log("categoryChangeLinks[18]", categoryChangeLinks[18]); //{ cat1: '', cat2: '', cat3: 70, cat4: '' }
// categoryChangeLinks[18] ~categoryChangeLinks[305] :  cat3 과 cat4에 대한 분류
console.log("categoryChangeLinks[306]", categoryChangeLinks[306]); //{ cat1: '', cat2: 12, cat3: '', cat4: '' }
// categoryChangeLinks[305] ~categoryChangeLinks[4589] :  cat2, cat3 과 cat4에 대한 분류
console.log("categoryChangeLinks[4590]", categoryChangeLinks[4590]); //{ cat1: 6, cat2: '', cat3: '', cat4: '' }
// categoryChangeLinks[4590] ~categoryChangeLinks[68849] : cat1, cat2, cat3 과 cat4에 대한 분류
console.log("categoryChangeLinks[68849]", categoryChangeLinks[68849]); //{ cat1: 11, cat2: 22, cat3: 34, cat4: 62 }
