...
const BasicForm = ({
  ...
  useMemo(() => {
    if (totalInfoState !== undefined && totalInfoState.length > 0) {
      ...
      //select은 null값 X
      totalInfoState[0].category_kind &&
        setKind(totalInfoState[0].category_kind);
      totalInfoState[0].category_theme &&
        setRecipeTheme(totalInfoState[0].category_theme);
      totalInfoState[0].category_way &&
        setRecipeWay(totalInfoState[0].category_way);
      totalInfoState[0].category_ing &&
        setRecipeWay(totalInfoState[0].category_ing);
      totalInfoState[0].information_person &&
        setServingSize(totalInfoState[0].information_person);
      totalInfoState[0].information_level &&
        setLevel(totalInfoState[0].information_level);
      totalInfoState[0].information_time &&
  ...
  // if (recipeState) {
  //   console.log("recipeState[0]", recipeState[0]);
  //   // setTotalInfoState(recipeState);
  //   // console.log("totalInfoState", totalInfoState);
  // }
  ...
  const onTemporarySave = useCallback(
    (e) => {
      ...
      if (totalInfoState[0].recipe_rpath === recipe_rpath) {
